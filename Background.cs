...
namespace StorybrewScripts
{
    public class Background : StoryboardObjectGenerator
    {
        private List<Timing> timings = new List<Timing>()
        {
            ...
            Framing.New(2854, Colors.White),
            Framing.New(2876, Colors.Dark),
            Framing.New(2882, Colors.Sun),
            Framing.New(2890, Colors.Red),
            Framing.New(2904, Colors.Dark),
            Framing.New(2911, Colors.Sun),
            Framing.New(2930, Colors.White),
            Framing.New(2941, Colors.Red),
            Framing.New(2951, Colors.Sun),
            Framing.New(2962, Colors.White),
            Framing.New(2966, Colors.Sun),
            Framing.New(2983, Colors.Dark),
            Framing.New(2993, Colors.White),
            Framing.New(3000, Colors.Sun),
            Framing.New(3004, Colors.White),
            Framing.New(3013, Colors.Dark),
            Framing.New(3016, Colors.Sun),
            Framing.New(3022, Colors.White),
            Framing.New(3030, Colors.Sun),
            Framing.New(3033, Colors.White),
            Framing.New(3040, Colors.Dark),
            Framing.New(3045, Colors.Sun),
            Framing.New(3051, Colors.Red),
            Framing.New(3061, Colors.White),
            Framing.New(3076, Colors.Dark),
            Framing.New(3082, Colors.White),
            Framing.New(3086, Colors.Dark),
            Framing.New(3097, Colors.White),
            Framing.New(3107, Colors.Dark),
            Framing.New(3112, Colors.Sun),
            Framing.New(3127, Colors.Dark),
            Framing.New(3133, Colors.Red),
            Framing.New(3147, Colors.Dark),
            Framing.New(3165, Colors.White),
