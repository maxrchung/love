...
namespace StorybrewScripts
{
    ...
    public class BlenderEdges : StoryboardObjectGenerator
    {
        private List<Timing> timings = new List<Timing>()
        {
            ...
            // yeah yeah
            Framing.New(2840, Colors.White),
            Framing.New(2854, Colors.Red),
            Framing.New(2876, Colors.White),
            Framing.New(2882, Colors.Dark),
            Framing.New(2890, Colors.Sun),
            Framing.New(2904, Colors.White),
            Framing.New(2911, Colors.Dark),
            Framing.New(2930, Colors.Sun),
            Framing.New(2941, Colors.White),
            Framing.New(2951, Colors.Dark),
            Framing.New(2962, Colors.Sun),
            Framing.New(2966, Colors.Dark),
            Framing.New(2983, Colors.White),
            Framing.New(2993, Colors.Red),
            Framing.New(3000, Colors.White),
            Framing.New(3004, Colors.Red),
            Framing.New(3013, Colors.Sun),
            Framing.New(3016, Colors.Dark),
            Framing.New(3022, Colors.Red),
            Framing.New(3030, Colors.White),
            Framing.New(3033, Colors.Red),
            Framing.New(3040, Colors.Sun),
            Framing.New(3045, Colors.Red),
            Framing.New(3051, Colors.Sun),
            Framing.New(3061, Colors.Red),
            Framing.New(3076, Colors.Sun),
            Framing.New(3082, Colors.Red),
            Framing.New(3086, Colors.White),
            Framing.New(3097, Colors.Sun),
            Framing.New(3107, Colors.White),
            Framing.New(3112, Colors.Dark),
            Framing.New(3127, Colors.Sun),
            Framing.New(3133, Colors.White),
            Framing.New(3147, Colors.Red),
            Framing.New(3165, Colors.Dark),
            Framing.New(3173, Colors.White),
            Framing.New(3177, Colors.Sun),
            Framing.New(3190, Colors.Dark),
            Framing.New(3200, Colors.Red),
            Framing.New(3229, Colors.White),
            Framing.New(3241, Colors.Sun),
            Framing.New(3246, Colors.Red),
            Framing.New(3252, Colors.Sun),
            Framing.New(3257, Colors.Dark),
            Framing.New(3262, Colors.White),
            Framing.New(3284, Colors.Red),
            Framing.New(3291, Colors.Sun),
